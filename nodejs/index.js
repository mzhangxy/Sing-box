...
const UUID = process.env.UUID || '14e709cd-142b-4e9f-b0a6-cf0e4c14da66';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiMWNjMWIyNGItZGE2Mi00MjcxLWJjYzgtMzBlN2IwYjQ0ZGI3IiwicyI6Ik9UVTNNbUkyTWpjdFltRTJNeTAwWVRZMkxUZzVNMll0TWprNE1qWXpZMlkwWWpRMiJ8';               // argo固定隧道token或json,留空即使用临时隧道
const ARGO_PORT = process.env.ARGO_PORT || 59001;             // argo固定隧道端口,使用token需在cloudflare控制台设置和这里一致，否则节点不通
...
const NAME = process.env.NAME || 'Vm';                         // 节点名称
